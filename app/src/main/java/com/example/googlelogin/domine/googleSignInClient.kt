package com.example.googlelogin.domine
...
class GoogleAuthClient(
    ...
    private suspend fun buildCredentialRequest(activity: Activity): GetCredentialResponse {
        val request = GetCredentialRequest.Builder()
            .addCredentialOption(
                GetGoogleIdOption.Builder()
                    ...
                    .setServerClientId("792548933114-vqts0a7vdc54buenk3e1dohh5q7924hc.apps.googleusercontent.com")
        ...
        return CredentialManager.create(activity).getCredential(
            request = request,
            context = activity  // Use Activity context here
        )
    }
    suspend fun signOut() {
